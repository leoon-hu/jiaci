...
export default async function WordbooksPage() {
  ...
  const initial = books.map((b) => {
    ...
    return { id: b.id, name: b.name, type: b.type, wordCount: b.wordCount, createdAt: b.createdAt.toISOString(), learned: p.learned, mastered: p.mastered, removed: p.removed, isCurrent: b.id === currentId };
  });
